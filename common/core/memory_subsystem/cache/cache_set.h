...
class CacheSet
{
   ...
   public:
      ...
      void insert(CacheBlockInfo* cache_block_info, Byte* fill_buff, bool* eviction, CacheBlockInfo* evict_block_info, Byte* evict_buff, int& replacement_index, CacheCntlr *cntlr = NULL);
